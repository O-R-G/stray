...
function request_json(name, request_url, data_type, results_count = false, use_header = true, cache_lifecycle = false) {
    ...
    request_live(name, request_url, data_type, results_count, use_header, now_timestamp);
}

function request_live(name, request_url, data_type,results_count = false, use_header = true, now_timestamp, cache_lifecycle = false){
